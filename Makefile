...
SRC			= 	$(SRC_DIR)/main.c \
				...
				src/execution/handle_redir.c src/execution/heredoc_utils.c src/execution/heredoc_utils2.c src/execution/heredoc.c src/execution/redirection.c src/execution/signal.c
