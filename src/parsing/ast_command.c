...
/*   Updated: 2025/04/02 13:23:19 by jwardeng         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    parse_command_args(t_token_data **token_data, t_token **current, t_ast *cmd_node)
{
    int i;
	...
	// add logic to check for built in && external commands.
	// if(token_command(cmd_node->args[0], ft_strlen(cmd_node->args[0])) == 1)
